...
const RecentSearch = ({
  ...
  return (
    <>
      <div
        className=' md:hidden flex fixed top-3 left-3 z-40 '
        onClick={() => setNav(!nav)}
      >
      ...
      <div>
        <div
          className={`${
            nav ? "block" : "hidden"
          } md:w-[20vw] md:block min-w-[220px] md:min-w-[200px] col-span-4 dark:bg-zinc-800 bg-zinc-200 w-[40vw] fixed h-screen pt-3 z-30`}
        >
          <h1 className='text-xl dark:text-white flex pl-2  items-start gap-2 flex-col relative top-10 md:static'>
            ...
            <span className='flex gap-2'>
              ...
              <button
                className='flex items-center gap-2  dark:bg-zinc-700 bg-zinc-300 rounded-full dark:hover-bg-zinc-600 hover:bg-zinc-400 px-3 py-2'
                onClick={()=>{
                  clearChat() 
                  setNav(!true);
                }}
