  ...
  return (<>
    ...
    <div className='flex w-full my-0.5 sm:my-3 max-w-[90vw] ]' >
      {index === 0 && totalResult > 1 ? (
        <span className='font-medium sm:text-[25px] text-[14px] dark:text-white mb-1' >
          {answer}
        </span>
      ) : heading ? (
        <span className='font-medium sm:text-[23px] text-[13px] dark:text-white ' >
          {answer}
        </span>
      ) : (
        ...
        <div
          className={
            type === "q"
              ...
              : "md:pl-3 pl-1 md:my-2 md:w-[60vw] w-full max-w-[90vw] sm:text-[16px] text-[11px]"
          }
        >
